...
let x = 5, y = 4, z, loggedIn, userName = "Steve";
...
function setWeather() {
    ...
    switch (choice) {
        case "sunny":
            para.textContent =
            "It is nice and sunny outside today. Wear \
            shorts! Go to the beach, or the park, and get an \
            ice cream.";
            break;
        case "rainy":
            para.textContent =
            "Rain is falling outside; take a rain coat \
            and an umbrella, and don't stay out for too long";
            break;
        case "snowing":
            para.textContent =
        ...
        case "overcast":
            para.textContent =
            "It isn't raining, but the sky is grey and \
            gloomy; it could turn any minute, so take a rain \
            coat just in case.";
            break;
        default:
            para.textContent = "";
